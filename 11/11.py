...
plt.show()
# выпр линейный элемент

## по умолчанию 100 скрытых узлов
...
## настраиваем сложность с помощью l2 штрафа
...
## Важным свойством нейронных сетей является то, что их веса задаются случайным
## образом перед  началом  обучения  и  случайная  инициализация  влияет  на  процесс  обучения  модели.
fig, axes = plt.subplots(2, 4, figsize=(20, 8))
...
print("Увеличили количество итераций:")
...
print("Уменьшаем сложность модели с увеличенным параметром альфа:")
...
## весовые коэффициенты, которые были вычислены при подключении входного слоя к первому скрытому слою

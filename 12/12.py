...
## оценка неопределённостей классификаторов
#decision function predict proba
...
## произвольное   масштабирование   часто   затрудняет   интерпретацию   вывода decision_function.
## строим decision_function для всех точек двумерной плоскости
## Для удобства визуализации decision_function преобразуется с помощью произвольного масштабирования, чтобы его значения были близки к 0
...
## predict_proba - вер-ть каждого класса
#Модель называется калиброванной (calibrated), если вычисленная неопределенность соответствует
...
## неопределённость в мультиклассовой классификации
...
Спрогнозированные вероятности predict_proba:\n{gbrt.predict_proba(X_test)[:6]}
...
## Если вы хотитесравнить результаты, полученные с помощью predict, с результатами decision_function или predict_proba,

...
# линейные модели для мультиклассовой классифиации

# используя бинарный классификатор, мы получаем один вектор коэфф и одну константу по каждому классу
...
# каждая строка содержит вектор коэффициентов для каждого из трёх классов, а каждый столбец - коэф для признака
